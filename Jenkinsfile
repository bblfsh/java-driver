pipeline {
  agent {
    kubernetes {
      label 'java-driver-bblfsh-performance'
      defaultContainer 'java-driver-bblfsh-performance'
      yaml """
spec:
  nodeSelector:
  ...
  containers:
  - name: java-driver-bblfsh-performance
...
"""
  ...
  environment {
    ...
    DRIVER_REPO = "https://github.com/bblfsh/java-driver.git"
